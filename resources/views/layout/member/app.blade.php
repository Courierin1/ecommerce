                    ...
                    <ul class="nav sidebar-inner" id="sidebar-menu">
                        ...
                        <li class="has-sub">
                            <a class="sidenav-item-link" href="javascript:void(0)" data-toggle="collapse"
                                data-target="#Dashboard" aria-expanded="false" aria-controls="documentation">
                        ...
                        <li class="has-sub">
                            <a class="sidenav-item-link" href="javascript:void(0)" data-toggle="collapse"
                                data-target="#Transactions" aria-expanded="false" aria-controls="documentation">

                                <i class="fa-solid fa-cart-shopping"></i>
                                <span class="nav-text">Past Transactions</span> <b class="caret"></b>
                            </a>
                            <ul class="collapse" id="Transactions" data-parent="#sidebar-menu">
                                <div class="sub-menu">
                                    <li>
                                        <a class="sidenav-item-link" href="{{route('user.transactions')}}">
                                            <span class="nav-text">View Past Transactions</span>
                                        </a>
                                    </li>
                        ...
                        <!-- <li class="has-sub">
                            <a class="sidenav-item-link" href="javascript:void(0)" data-toggle="collapse"
                                data-target="#Payment" aria-expanded="false" aria-controls="documentation">
                                <i class="fa-solid fa-money-bill"></i>
                                <span class="nav-text">Payment Setting</span> <b class="caret"></b>
                            </a>
                            <ul class="collapse" id="Payment" data-parent="#sidebar-menu">
                                <div class="sub-menu">
                                    ...
                                    <li>
                                        <a class="sidenav-item-link" href="{{route('user.payment_details')}}">
                                            <span class="nav-text">View Payments Details</span>
                                        </a>
                                    </li>
                        ...
                        <li class="has-sub">
                            <a class="sidenav-item-link" href="javascript:void(0)" data-toggle="collapse"
                                ...
                                <span class="nav-text">Account Setting</span> <b class="caret"></b>
                            </a>
                            <ul class="collapse" id="categories" data-parent="#sidebar-menu">
                                <div class="sub-menu">
                                    <li>
                                        <a class="sidenav-item-link" href="{{route('user.information')}}">
                                            <span class="nav-text">Account Informations</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a class="sidenav-item-link" href="{{route('user.edit_password')}}">
