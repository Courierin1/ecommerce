...
<!-- Banner Section -->
{{-- <section class="innerbanner yellow-bg" style="background: url(../images/bg.png) #fb8200 center">
    <div class="row align-items-center">
        <div class="col-md-4">
            <div class="innercaption yellow-bg shadow party bg-black2 container-fluid ml-4" style="background: #ffb458; padding: 15px ">
                <h2 class="text-red">A party with a Purpose</h2>
                <p>Sharing the Love of Jesus through Selling Christian Jewelry</p>
            </div>
        </div>
        <div class="col-md-8">
            <img src="{{ asset('images/jwelleryforparty_.png') }}" class="img-fluid w-100" alt="">
        </div>
    </div>
...
{{-- <section class="bg-black">
    ...
    <div class="inner-image">
         <img src="{{ asset('images/accessories.jpg') }}" class="img-fluid w-100" alt="">
         <img src="{{ asset('images/Parties.png') }}" class="img-fluid w-100" alt="">
    </div>
    <div class="container">
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="innercaption party">
                    <h2 class="text-red">A party with a Purpose</h2>
                    <p>Sharing the Love of Jesus through Selling Christian Jewelry</p>
                </div>
            </div>
...
<section class="bg-dark" style="border-bottom: 50px solid #F6931E">
    <div class="row bg-img">
        ...
        <div class="col-md-6 d-flex justify-content-end">
            <img src="{{asset('images/jwelleryforparty_.png')}}" alt="" class="img-fluid">
        </div>
    </div>
</section>
<section class="bg-dark" style="border-bottom: 50px solid #F6931E">
...
<!-- product Category -->
    {{-- <section class="kitsec">
        <div class="container">
            <h2 class="text-center">Pick a Starter Kit</h2>
            @if(isset($kits))
                <div class="row">
                    @foreach($kits as $kit)
                        <div class="col-md-3 col-sm-6 col-xs-12">
                            ...
                            <a href="{{ route ('pricing') }}" class="theme-btn d-inline-block">Pick
                                Now</a>
                        </div>
                        <!-- <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="kit" id="style-9">
    ...
    <section class="consult-sec py-5" id="consultant">
        <div class="container">
            ...
            <p class="text-center">JUST FOLLOW THESE 3 EASY STEPS</p>
            <div class="stepwizard">
                <div class="stepwizard-row setup-panel">
                    <div class="stepwizard-step prev">
                        <a href="#step-1" type="button" class="btn btn-primary btn-circle" disabled>1</a>
                        <p>Choose Your Sponsor <span class="d-block">Step 1</span></p>
                    </div>
                    <div class="stepwizard-step">
                        <a href="#step-2" type="button" class="btn btn-default btn-circle" disabled="disabled">2</a>
                        <p>Choose a Kit <span class="d-block">Step 2</span></p>
                    </div>
                    <div class="stepwizard-step">
                        <a href="#step-3" type="button" class="btn btn-default btn-circle" disabled="disabled">3</a>
                        <p>Checkout <span class="d-block">Step 3</span></p>
                    </div>
                </div>
            </div>
